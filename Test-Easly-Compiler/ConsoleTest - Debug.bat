...
if not exist "..\Test-Easly-Compiler\bin\x64\Debug\Test-Easly-Compiler.dll" goto error_EaslyCompiler
del *.log
"..\packages\NUnit.ConsoleRunner.3.9.0\tools\nunit3-console.exe" --trace=Debug --labels=All "./bin/x64/Debug/Test-Easly-Compiler.dll"
goto end
