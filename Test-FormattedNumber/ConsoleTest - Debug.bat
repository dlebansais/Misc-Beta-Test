...
if not exist "..\Test-FormattedNumber\bin\x64\Debug\Test-FormattedNumber.dll" goto error_FormattedNumber
"..\packages\NUnit.ConsoleRunner.3.9.0\tools\nunit3-console.exe" --trace=Debug --labels=All "..\Test-FormattedNumber\bin\x64\Debug\Test-FormattedNumber.dll"
goto end
